...
<MetaTags
	title="ระบบบันทึกกิจกรรม คณะวิทยาศาสตร์และเทคโนโลยี"
	description="ลงทะเบียน เช็คอินเข้าร่วม และดูประวัติกิจกรรมนักศึกษาของคณะวิทยาศาสตร์และเทคโนโลยี มหาวิทยาลัยราชภัฏเทพสตรี พร้อมสรุปชั่วโมงสะสมและรายงานกิจกรรมในที่เดียว"
	type="website"
/>
