<script lang="ts">
	...
	const {
		title,
		description = 'ระบบบันทึกกิจกรรมนักศึกษาของคณะวิทยาศาสตร์และเทคโนโลยี มหาวิทยาลัยราชภัฏเทพสตรี ลงทะเบียน เช็คอิน เช็คเอาท์ และดูประวัติการเข้าร่วมกิจกรรมพร้อมชั่วโมงสะสมได้ในที่เดียว',
