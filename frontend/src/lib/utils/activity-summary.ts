...
export function calculateProgress(
	...
	const facultyProgress = {
		...
		percentage: Math.min(
			100,
			calculatePercentage(stats.facultyLevel.hours, requirements.requiredFacultyHours)
		),
	...
	const universityProgress = {
		...
		percentage: Math.min(
			100,
			calculatePercentage(stats.universityLevel.hours, requirements.requiredUniversityHours)
		),
