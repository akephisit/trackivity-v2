...
async function main() {
  ...
  if (args.length < 5) {
    console.log('Usage: npm run create-super-admin <studentId> <email> <password> <firstName> <lastName>');
    console.log('Example: npm run create-super-admin SA001 admin@university.ac.th MySecurePassword123! John Doe');
    process.exit(1);
  }
